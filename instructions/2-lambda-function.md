...
[Voice User Interface](../instructions/1-voice-user-interface.md) || [Lambda Function](../instructions/2-lambda-function.md) || [Connect VUI to Code](../instructions/3-connect-vui-to-code.md) || [Testing](../instructions/4-testing.md) || [Customization](../instructions/5-customization.md) || [Intents and Slots](../instructions/6-intents-slots.md) || [Smart Recommendations](../instructions/7-smart-recommendations.md) || [Publication](../instructions/10-publication.md)
